            ...
            "slides": {
                ...
                "items": {
                    ...
                    "properties": {
                        ...
                        "content": {
                            "type": "string",
                            "description": "The content of the slide. Use newlines for bullet points.",
                        },
                        "layout": {
                            "type": "string",
                        ...
                        "font_name": {
                            "type": "string",
                            "description": "Font for the content text. Defaults to 'Arial'.",
                        },
                        "font_size": {
                            "type": "integer",
                            "description": "Font size for the content text. Defaults to 18.",
                        },
                        "font_color": {
                            "type": "string",
                            "description": "Hex code for font color (e.g., 'FF0000' for red).",
                        },
                        "background_color": {
                            "type": "string",
                            "description": "Hex code for slide background color (e.g., '0000FF' for blue).",
                        },
                    },
                    "required": ["title"],
                },
                ...
                if layout_index == 1 and slide.placeholders[1]:
                    ...
                    for para in tf.paragraphs:
                        for run in para.runs:
                            ...
                            if font_color_hex and re.match(
                                r"^[0-9a-fA-F]{6}$", font_color_hex
                            ):
                    ...
                    layout_index == 0 and slide.placeholders[1]
