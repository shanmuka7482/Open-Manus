        ...
        <div className="flex-1 px-4">
          <nav className="space-y-2">
            <button
              ...
              className={`w-full flex items-center space-x-3 px-3 py-2.5 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-primary/50 ${currentPage === 'home'
            ...
            <button
              ...
              className={`w-full flex items-center space-x-3 px-3 py-2.5 rounded-lg transition-colors ${currentPage === 'sandbox'
                  ? 'bg-primary/10 text-primary border border-primary/20'
                  : 'text-foreground hover:text-foreground hover:bg-muted/50'
                }`}
              aria-label="Navigate to Sandbox"
            >
            ...
            <button
              ...
              className={`w-full flex items-center space-x-3 px-3 py-2.5 rounded-lg transition-colors ${currentPage === 'pricing'
                  ? 'bg-primary/10 text-primary border border-primary/20'
                  : 'text-foreground hover:text-foreground hover:bg-muted/50'
                }`}
        ...
        <div className="p-4">
          <div className="space-y-2">
            <button
              ...
              className={`w-full flex items-center space-x-3 px-3 py-2.5 rounded-lg transition-colors ${currentPage === 'history'
                  ? 'bg-primary/10 text-primary border border-primary/20'
                  : 'text-foreground hover:text-foreground hover:bg-muted/50'
                }`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center space-x-3 px-3 py-2.5 rounded-lg transition-colors ${currentPage === 'settings'
                  ? 'bg-primary/10 text-primary border border-primary/20'
                  : 'text-foreground hover:text-foreground hover:bg-muted/50'
                }`}
            >
